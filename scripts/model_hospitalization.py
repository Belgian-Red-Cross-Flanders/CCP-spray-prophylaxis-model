...
# ax_E = plt.axes([0.20, 0.20, 0.60, 0.02])

# ax_hr = plt.axes([0.20, 0.16, 0.60, 0.02])

# ax_dose = plt.axes([0.20, 0.12, 0.60, 0.02])

# ax_cap = plt.axes([0.20, 0.08, 0.60, 0.02])

# ax_donor = plt.axes([0.20, 0.04, 0.60, 0.02])

# ax_adopt = plt.axes([0.20, 0.00, 0.60, 0.02])
...
#         A_max=slider_adopt.val,

#         capacity_per_day=slider_cap.val,

#         treatment_duration=treatment_duration,

#         ccp_lifetime=ccp_lifetime,

#         potential_donor_rate=slider_donor.val,
...
#         dose_volume=slider_dose.val,

#         high_risk_fraction=slider_hr.val,
...
# slider_hr.on_changed(update)

# slider_dose.on_changed(update)

# slider_cap.on_changed(update)

# slider_donor.on_changed(update)

# slider_adopt.on_changed(update)